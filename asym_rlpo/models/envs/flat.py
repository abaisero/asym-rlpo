...
class FlatModelFactory(ModelFactory):
    def make_latent_model(self) -> Model:
        assert isinstance(self.env.latent_space, gym.spaces.Discrete)
        return EmbeddingModel(self.env.latent_space.n, 64)
    ...
    def make_observation_model(self) -> Model:
        ...
        return EmbeddingModel(self.env.observation_space.n, 64)
